...
\outl0\strokewidth0 \strokec2 # Set up the Page Title and Look\
st.set_page_config(page_title="The Bestie Lab", page_icon="\uc0\u55358 \u56810 ")\
\
st.title("\uc0\u55358 \u56810  The Bestie Compatibility Lab")\
...
if st.button("Calculate Our Compatibility! \uc0\u10024 "):\
...
\
    if scores1[0] > 7 and scores2[0] > 7:\
        st.warning("\uc0\u9888 \u65039  High Matchmaking Energy Detected: No secret is safe with you two!")\
    \
    if match_pct > 80:\
        st.success("You're practically the same person! \uc0\u55357 \u56431 \u8205 \u9792 \u65039 ")\
    elif match_pct > 50:\
        st.info("A solid friendship! Enough in common to never be bored. \uc0\u55356 \u57096 ")\
    else:\
        st.write("Opposites attract! You bring different vibes to the table. \uc0\u55358 \u56809 ")}